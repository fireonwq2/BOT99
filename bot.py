...
async def create_server_custom(interaction, ram, cores):
    ...
    try:
        ...
        # Set root password and enable SSH inside container
...
@app_commands.describe(ram="Amount of RAM (e.g., 2g, 4g, 8g, 16g)", cores="Number of CPU cores (e.g., 1, 2, 4, 8)")
async def deploy_custom(interaction: discord.Interaction, ram: str, cores: str):
    await interaction.response.defer()
    ...
    await create_server_custom(interaction, ram, cores)
